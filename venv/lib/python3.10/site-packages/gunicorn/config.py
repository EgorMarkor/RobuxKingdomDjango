...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b http://rbxkingdom.com -b [::1]:8000 test:app
...
class Env(Setting):
    ...
    desc = """\
        ...
        .. code-block:: console
            ...
            $ gunicorn -b http://rbxkingdom.com --env FOO=1 test:app
...
class PasteGlobalConf(Setting):
    ...
    desc = """\
        ...
        The variables are passed to the PasteDeploy entrypoint. Example::
            ...
            $ gunicorn -b http://rbxkingdom.com --paste development.ini --paste-global FOO=1 --paste-global BAR=2
